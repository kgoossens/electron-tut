...
class MenuManager {
    ...
    getViewMenuTemplate() {
        return {
            label: 'View',
            submenu: [
                {label: 'Map', click: this.onMap},
                {label: 'Select Location', click: this.onLocations},
                {type: 'separator'},
                {role: 'reload'},
                {role: 'forcereload'},
                {role: 'toggledevtools'},
    ...
    getHelpMenuTemplate() {
        let menu = {
            role: 'help',
            submenu: [
                {label: 'Learn More', click: this.onLearnMore}
            ]
        }
    ...
    getMacAppMenuTemplate() {
        return {
            label: '',
            submenu: [
                {label: 'About Dispatcher', click: this.onAbout},
                {type: 'separator'},
                {label: 'Preferences...', click: this.onPrefs},
                {type: 'separator'},
